  ...
  <div id="entry">
    ...
    >
      ...
      <div class="entry-description">
        ...
        repudiandae iusto id! Provident, neque architecto officia ipsum enim
        fuga libero dolore repudiandae asperiores voluptate sequi numquam, ex
        nostrum deleniti error?
      </div>
    </div>
  </div>
</template>
